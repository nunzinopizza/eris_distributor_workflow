...
Define test scope, environments, responsibilities, data, entry/exit criteria, unit, integration, security, regression, recovery, and user-acceptance testing.
...
**Requires:** DOC-003, DOC-007, DOC-008, DOC-009, DOC-010, DOC-011, DOC-012, DOC-013, DOC-014, DOC-015

**Provides input to:** DOC-020
...
- [ ] Define test environments and test-data controls.
- [ ] Define functional, integration, document, email, security, concurrency, failure, recovery, and regression coverage.
- [ ] Define entry, exit, defect, and sign-off criteria.

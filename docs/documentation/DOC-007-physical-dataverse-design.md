# DOC-007 - Physical Dataverse Design
...
Specify actual Dataverse tables, columns, data types, lengths, required levels, relationships, indexes, alternate keys, choices, auditing, and security configuration.
...
**Requires:** DOC-006, DOC-013

**Provides input to:** DOC-009, DOC-010, DOC-015, DOC-016
...
- [ ] Complete DOC-006 first.
- [ ] Define publisher prefix and naming standards.
- [ ] Create the physical table and column register.
- [ ] Define alternate keys, calculated fields, rollups, auditing, ownership, and indexes.
- [ ] Validate the design in a development environment.

...
| TR-004 | §3 Steps 1–34 | Execute the ordered operating workflow from entry selection through cancellation, including each stated output and recovery path. | Confirmed | Phases 1–6; acceptance tests AT-01 through AT-23. |
